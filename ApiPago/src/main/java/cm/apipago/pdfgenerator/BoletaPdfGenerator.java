...
public class BoletaPdfGenerator implements  ComprobantePdfGenerator{
    ...
    public byte[] generarPdf(ComprobantePagoResponse response) {
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            rightCell.addElement(new Phrase("DATOS DEL PACIENTE", headerFont));
            rightCell.addElement(new Phrase("Nombre: " + response.nombrePaciente(), normalFont));
            rightCell.addElement(new Phrase("DNI: " + response.dniPaciente(), normalFont));
    ...
    private String formatMetodoPago(PagoCita.MetodoPago metodoPago) {
        // Convierte el enum a un formato más legible
